...
const STATUS_BY_CODE = {
  ...
  SETUP_ORIGIN_INVALID: 403,
  SETUP_WRITE_FAILED: 500,
...
const DEFAULT_MESSAGES = {
  ...
  SETUP_TOKEN_INVALID: 'Invalid or already-used setup token',
  SETUP_VALIDATION_FAILED: 'Invalid setup values',
  SETUP_ORIGIN_INVALID: 'Setup origin not allowed',
  SETUP_WRITE_FAILED: 'Failed to write server configuration',
